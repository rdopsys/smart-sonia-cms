...
/*
                    ...
                    <tr valign="top" class="wpacu-license-extra-info">
                        ...
                        <td style="padding-bottom: 18px;">
	                        <span style="background: rgba(255, 255, 255, 0.5); border: 1px solid #e7e7e7; border-radius: 4px; padding: 5px;">
	                            ...
	                            echo (int)$license_data->site_count.' / <strong>'.(int)$licenseLimit.'</strong>';
								?>
	                        </span>
	                        <?php
                            echo '&nbsp;&nbsp;';
				...
				if (in_array($license_data->license, array('valid', 'expired', 'site_inactive', 'invalid', 'disabled'))) {
					...
					<?php  if ($license_data->license === 'expired') { ?>
						<span style="color: #cc0000; font-weight: bold;"><?php _e('expired', 'wp-asset-clean-up'); ?>&nbsp;&nbsp;</span> <span style="vertical-align: top;" id="wpacu-license-renewal-link">&nbsp;<a href="<?php echo esc_url(self::generateRenewalLink($licenseKeyValue, $license_data)); ?>" class="button button-primary">Renew License for a 15% discount</a></span>
					<?php } ?>
