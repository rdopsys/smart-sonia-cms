...
$css_class  = 'wpc-filter-item wpc-filter-' . $apply_button['value'];
    ...
    <div class="wpc-filter-head">
        <div class="wpc-filter-title ui-sortable-handle">
            <ul class="wpc-custom-row wpc-filter-item-labels">
                <li class="wpc-filter-order"><span class="wpc-filter-sortable-handle dashicons dashicons-menu"></span></li>
