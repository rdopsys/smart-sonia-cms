 ...
 * Plugin URI: http://blapps.eu/simple-xml-image-sitemap
 * Description: The Simple Image XML Sitemap plugin will generate an XML Sitemap for all images, including Woocommerce products. Open the <a href="tools.php?page=simple-xml-image-sitemap">Tools</a> page to create your image sitemap.
 * Author: blapps
 * Version: 3.2
 * Tested up to: 5.7
