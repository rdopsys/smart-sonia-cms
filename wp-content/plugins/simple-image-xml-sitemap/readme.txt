...
The plugin is written by Janine of [Blapps.eu](https://blapps.eu/ ""), and is based on Herbert van-Vliet's image sitemap plugin.

= More information about this Plugin =
Further official details available on [Blapps.eu](http://blapps.eu/simple-image-xml-sitemap?utm_campaign=simple-image-xml-sitemap&utm_medium=content-link&utm_source=wordpress.org).
