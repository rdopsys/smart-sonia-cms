...
use BracketSpace\Notification\Dependencies\enshrined\svgSanitize\ElementReference\Subject;

/**
 * Class Sanitizer
 *
 * @package BracketSpace\Notification\Dependencies\enshrined\svgSanitize
 */
class Sanitizer
{
