<?php ! defined( 'ABSPATH' ) && exit(); ?><div class="totalpoll-options-debug">
    ...
    <p>
        <button type="button" ng-click="$ctrl.downloadDebugInformation()" class="button button-primary button-large"><?php esc_html_e( 'Download', 'totalpoll' ); ?></button>
    </p>
</div>
