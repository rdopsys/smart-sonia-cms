<?php ! defined( 'ABSPATH' ) && exit(); ?><script  type="text/ng-template" id="finish-component-template">
    ...
    <p class="lead"><?php echo $this->getContent('finish.description') ?></p>
        <div class="row">
            ...
            <div class="col-md information-box">
                ...
                <hr>
                <p><span class="material-icons">check</span> Make TotalPoll stable and bug-free.</p>
                ...
                <img src="<?php echo esc_attr( $this->env['url'] ); ?>assets/dist/images/onboarding/why.svg" alt="Wondering">
            </div>
        </div>
