...
class Bootstrap {
	...
	public function __construct( Request $request, Environment $env ) {
		...
		if ( Arrays::getDotNotation( $this->onboarding, 'status', 'init' ) === 'init' && current_user_can( 'manage_options' ) ) {
	...
	public function footerText() {
		$text = wp_kses(__( '{{product}} is part of <a href="{{totalsuite}}" target="_blank">TotalSuite</a>, a suite of robust and maintained plugins for WordPress.', 'totalpoll' ), ['a' => ['href' => []]]);
