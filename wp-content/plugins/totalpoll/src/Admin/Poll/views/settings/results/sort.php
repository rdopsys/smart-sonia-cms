<?php ! defined( 'ABSPATH' ) && exit(); ?><div class="totalpoll-settings-item">
    <div class="totalpoll-settings-field">
        ...
        <p>
            ...
            &nbsp;&nbsp;
            <label>
                <input type="radio" name="" value="label" ng-model="editor.settings.results.sort.field" >
				<?php esc_html_e( 'Label', 'totalpoll' ); ?>
                
            </label>
            &nbsp;&nbsp;
            <label>
                <input type="radio" name="" value="random" ng-model="editor.settings.results.sort.field" >
