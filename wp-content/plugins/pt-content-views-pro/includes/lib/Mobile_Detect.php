 ...
 */
/**
 * Just replaced name Mobile_Detect with Mobile_Detect_CV to prevent conflict problem with theme and other plugins
 * which defines Mobile_Detect class without checking class_exists()
 */
if ( !class_exists( 'Mobile_Detect_CV' ) ) {

	class Mobile_Detect_CV {
		...
		public function match( $regex, $userAgent = null ) {
			$match = (bool) preg_match( sprintf( '#%s#is', $regex ), (string) (false === empty( $userAgent ) ? $userAgent : $this->userAgent ), $matches );
