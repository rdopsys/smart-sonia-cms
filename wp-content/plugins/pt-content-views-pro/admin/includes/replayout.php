	...
	function get_archives() {
		...
		$this->archives_list = array(
			-1				 => array( __( 'Common Issues', 'content-views-pro' ), array(
					'skip-in-head'           => __( 'Fix the view shows unexpectedly in header of page', 'content-views-pro' ),
					'show-heading'			 => __( 'Fix the missing page title (title of page disappears when replacing layout)', 'content-views-pro' ),
