...
class Dimension extends WP_Customize_Control {
	...
	/**
	 * User_Registration_Customize_My_Account\Admin\Customizer\Controls\Dimension constructor.
	 *
			...
			<div class="dimension-input-wrapper">
				<ul class="dimension-inputs">
					...
					<div class="customize-control-content">
						<div class="user-registration-dimension"></div>
						<div class="user-registration-dimension-reset">
	...
	public function get_default_inputs() {
		return array(
			'top'    => esc_attr__( 'Top', 'user-registration-customize-my-account' ),
			'right'  => esc_attr__( 'Right', 'user-registration-customize-my-account' ),
			'bottom' => esc_attr__( 'Bottom', 'user-registration-customize-my-account' ),
			'left'   => esc_attr__( 'Left', 'user-registration-customize-my-account' ),
		);
	}
}
