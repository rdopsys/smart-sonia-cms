...
class mg_meta_fields {
	...
	private function setup_fields() {
		...
		$fields = array(
			...
			'mg_slider_h_val' => array(
				...
				'def'		=> 53,
				'max_val_len' => 4,
				'note'		=> __('% is related to its width. Leave empty to use default value', MG_ML),
	...
	public function type_fields() {
		switch($this->item_type) {
			...
			// lightbox slider
			case 'img_gallery' : 
				$f = array('mg_slider_img', 'mg_slider_h_val', 'mg_slider_crop', 'mg_slider_autoplay', 'mg_slider_thumbs','mg_slider_captions', 'mg_slider_random', 'mg_kenburns_fx', 'mg_cust_icon', 'mg_layout', 'mg_lb_max_w', 'mg_mf_lb_media_w', 'mg_lb_feat_match_txt', 'mg_cust_attr'); 
                break;	
			...
			// custom content
			case 'lb_text' : 
				$f = array('mg_kenburns_fx', 'mg_cust_icon', 'mg_layout', 'mg_lb_max_w', 'mg_lb_contents_padding'); 
                break;
			...
			case 'post' : 
				$f = array('mg_post_cats', 'mg_hide_feat_img', 'mg_link_only', 'mg_kenburns_fx', 'mg_cust_icon', 'mg_layout', 'mg_lb_max_w', 'mg_lb_feat_match_txt', 'mg_lb_img_display_mode', 'mg_img_maxheight', 'mg_lb_feat_match_txt', 'mg_lb_img_fx', 'mg_cust_attr'); 
                break;
