...
class ES_Service_Email_Sending extends ES_Services {
	...
	public function send_limit_data_to_ess() {
		...
		//$api_url = 'http://localhost:10025/wp-admin/admin-ajax.php?action=ihp_update_ess_account';
	...
	public static function can_show_ess_optin() {
		...
		if ( self::is_shown_previously() ) {
			return true;
		} elseif ( self::is_installed_on_same_month_day() ) {
			return true;
		}
