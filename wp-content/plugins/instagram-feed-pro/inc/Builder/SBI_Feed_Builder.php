...
class SBI_Feed_Builder {
	...
	*/
				...
				$sbi_builder = array(
					...
					'extensionsPopup'      => array(
						'socialwall' => array(
							...
							'heading'         => __( 'Combine all your social media channels into one', 'instagram-feed' ) . ' <span>' . __( 'Social Wall', 'instagram-feed' ) . '</span>',
	...
	public static function get_links_with_utm() {
		...
		$all_access_bundle       = sprintf( 'https://smashballoon.com/all-access/?license_key=%s&upgrade=true&utm_campaign=instagram-pro&utm_source=all-feeds&utm_medium=footer-banner&utm_content=learn-more', $license_key );
		...
		$sourceCombineCTA        = sprintf( 'https://smashballoon.com/social-wall/?license_key=%s&upgrade=true&utm_campaign=instagram-pro&utm_source=customizer&utm_medium=sources&utm_content=social-wall', $license_key );
