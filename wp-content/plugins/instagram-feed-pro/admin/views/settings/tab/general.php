                            ...
                            <div class="sb-srcs-item-inf">
                                ...
                                <div class="sb-srcs-item-used">
                                    ...
                                    <div v-if="source.error !== '' || source.error_encryption" class="sb-source-error-wrap">
                                        ...
                                        <span v-html="source.error !== '' ? genericText.errorSource : genericText.errorEncryption"></span><a href="#" @click.prevent.default="activateView('sourcePopup')" v-html="genericText.reconnect"></a>
                                    </div>
                                </div>
                            </div>
