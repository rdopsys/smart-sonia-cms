      ...
      c = function() {
        ...
        return b.prototype.init = function() {
          ...
          function c(a) {
            ...
            if (a.hasClass('sbi_header_link') && feed.storyData !== false) {
        ...
        $self.find('.sbi_item.sbi_new').each(function (index) {
          ...
          if ($self.find('.sbi_info .sbi_caption').length) {
            ...
            if (captionText.length > text_limit) {
              ...
              var short_textPlusOne = captionText.substring(0, text_limit + 1),
                short_textPlusOneLastChar = short_textPlusOne.charAt(short_textPlusOne.length - 1),
                lastWhiteSpace = short_text.lastIndexOf(' ');
              if ( lastWhiteSpace > 0 && short_textPlusOneLastChar !== ' ' ) {
                $caption.html(short_text.substring(0, lastWhiteSpace));
              }
            }
            //Click function
