...
(function($) {
    ...
    $(document).ready(function() {
        ...
        addOptionGeneral( 
            ...
            "dropdown",         
            "Access",         
            "Restrict direct access to flipbook", 
            ["full", "woo_subscription"]
        );
                        ...
                        pages.forEach(function(itemsArr, pageIndex){
                            itemsArr.forEach(function(item, itemIndex){
                                ...
                                if(o.pages[pageIndex].items[itemIndex].url){
                                    o.pages[pageIndex].items[itemIndex].url = unescape(unescape(o.pages[pageIndex].items[itemIndex].url))
                                }
        ...
        function addListeners() {
            ...
            $('.add-pdf-pages-button').on('click', function(e) {
                e.preventDefault();
