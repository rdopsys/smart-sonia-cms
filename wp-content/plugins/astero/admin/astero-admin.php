        ...
        function astero_custom_columns( $columns, $post_id ){
                ...
                switch ( $columns )
                {
                        ...
                        case "location":
                                ...
                                if ( isset( $meta['location'] ) && $meta['location'] == 'city' && isset( $meta['city_name'] ) && $meta['city_name'] != '' ) {
                                        echo $meta['city_name'];
                                } elseif ( isset( $meta['location'] ) && $meta['location'] == 'city' ) {
                                        _e('Default Location', ASTERO_SLUG);
                                } elseif( isset( $meta['location'] ) && $meta['location'] == 'ip' ) {
                                        _e('IP Detection Only', ASTERO_SLUG);
                                } else {
...
if (!function_exists('astero_meta_options'))
        ...
        function astero_meta_options(){ //Create media upload meta box
                ...
                $meta_keys = array(
                        ...
                        'search' => '',
                        'search_text' => 'I want to find the weather for [city] in [units] .',
                        'border_style' => '',
                        'border_size' => '',
                        'border_color' => '',
                        'display_units' => '0',
...
if( !function_exists('astero_update_static_css') ) {
        function astero_update_static_css() {
                ...
                if( file_exists( $filename ) && function_exists('file_put_contents') ) {
