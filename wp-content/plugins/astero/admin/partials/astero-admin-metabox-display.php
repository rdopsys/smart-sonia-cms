<div class="cmb-container">
        <div class="row">
                <div class="small-3 columns">
                        ...
                        <p class="description<?php if( $location != 'geolocation') echo ' js-hide'; ?>" data-check-field="location" data-check-value="location-geolocation">
                </div>
        ...
        <div class="row<?php if($location != 'city') echo ' js-hide'; ?>" data-check-field="location" data-check-value="location-city">
                <div class="small-3 columns">
                        <label><?php _e('Optional Displayed City Name', ASTERO_SLUG); ?></label>
                        <p class="description"><?php _e('Display using this optional city name.', ASTERO_SLUG); ?></p>
                </div>
                <div class="small-9 columns end">
                	<input type="text" class="regular-text" name="city_name" value="<?php echo $city_name; ?>" />
                </div>
        </div>
        <div class="row">
                <div class="small-3 columns">
        ...
        <div class="row">
                ...
                <div class="small-9 columns end">
                        <select name="lang" class="css-select">
                                <?php foreach ( $languages as $code => $l): ?>
                                <option value="<?php echo $code; ?>" <?php selected($lang, $code); ?>><?php echo $l; ?></option>
                                <?php endforeach; ?>
                        </select>
                </div>
        </div>
        <div class="row">
                ...
                <div class="small-9 columns end">
                        <input id="search" type="checkbox" class="select-change" name="search" value="1" <?php checked( $search, '1' ); ?>>
                </div>
        </div>
        <div class="row<?php if( $search != '1') echo ' js-hide'; ?>" data-check-field="search" data-check-value="search-1">
                <div class="small-3 columns">
                        <label><?php _e('Search Text', ASTERO_SLUG); ?></label>
                </div>
                <div class="small-9 columns end">
                	<textarea id="search_text" name="search_text"><?php echo $search_text; ?></textarea>
                	<p class="description"><?php _e('Use placeholder [city] for location input.', ASTERO_SLUG); ?></p>
                	<p class="description"><?php _e('Use placeholder [units] for unit selection (optional).', ASTERO_SLUG); ?></p>
                	<p class="description"><?php _e('Note: If [units] is not provided, defaults to the "Units" selected above.', ASTERO_SLUG); ?></p>
                </div>
        </div>
        <div class="row">
                <div class="small-3 columns">
        ...
        <div class="row">
                ...
                <div class="small-9 columns end">
                        ...
                        <div class="row cmb-row video-upload">
