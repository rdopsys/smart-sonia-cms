                ...
                <table class="form-table">
                        <tr valign="top">
                                ...
                                <td><input type="text" id="api" class="regular-text" name="<?php echo ASTERO_OPTIONS; ?>[api]" value="<?php echo isset( $astero_options['api'] ) ? $astero_options['api']: ''; ?>" /><br />
                                    <span class="description"><?php _e('Sign up for a free or paid Open Weather Map API key <a href="https://home.openweathermap.org/users/sign_up" target="_blank">here</a> and enter the API key above.', ASTERO_SLUG); ?></span></td>
                        </tr>
                        ...
                        <tr valign="top"<?php if( $skip_map == '1') echo ' class="hidden"'; ?> data-check-field="skip_map" data-check-value="skip_map-0">
                                ...
                                <td><input type="text" id="api" class="regular-text" name="<?php echo ASTERO_OPTIONS; ?>[google_map_api]" value="<?php echo isset( $astero_options['google_map_api'] ) ? $astero_options['google_map_api']: ''; ?>" /><br />
                                    <span class="description"><?php _e('Required for weather search on the frontend and for using city parameter in weather shortcode.<br>Please sign up for a Google Map API Key <a href="https://developers.google.com/maps/documentation/javascript/get-api-key#key" target="_blank">here</a> and enter the API key above.', ASTERO_SLUG); ?></span></td>
                        </tr>
                        <tr valign="top">
