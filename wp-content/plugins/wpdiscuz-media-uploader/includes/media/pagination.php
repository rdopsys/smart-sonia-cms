    ...
    <div class='wpd-pagination'>
        ...
        for ($i = $start; $i <= $end; $i++) {
            ...
            if ($i < $pageCount) {
                if ($i == $page) {
                    ?>
                    <span style="background: <?php echo $wpdiscuz->options->thread_styles["primaryColor"]; ?>;" class='wpd-page-link wpd-current-page' data-wpd-page='<?php echo $i; ?>'><?php echo $pageText; ?></span>
                <?php } else { ?>
