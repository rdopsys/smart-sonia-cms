<div class="wrap">
    <form method='post'>
      ...
      <div class="main_image_control_table">
        ...
        <table id="wp-accessibility-helper-image-control-table" class="wp-list-table widefat striped accessibility_table">
            <thead>
                <tr>
                    <td class="manage-column id_column"><?php _e("ID","wp-accessibility-helper"); ?></td>
                    <td class="manage-column preview_thumbnail"><?php _e("Thumbnail","wp-accessibility-helper"); ?></td>
                    <td class="manage-column title_column"><?php _e("Title","wp-accessibility-helper"); ?></td>
                    <td class="manage-column alt_column"><?php _e("Alt tag","wp-accessibility-helper"); ?></td>
                    <td class="manage-column edit_post_column"><?php _e("Edit image","wp-accessibility-helper"); ?></td>
                </tr>
            </thead>
            ...
            <tbody>
                <?php if($data_array) :?>
                  ...
                  <tr data-item="<?php echo $data['post_id']; ?>">
                    <td class="manage-column"><?php echo $data['post_id']; ?></td>
                    <td class="manage-column">
                      <img class="athumb" src="<?php echo $data['image']; ?>" alt="" />
                    </td>
                    <td class="manage-column title_box">
                    ...
                    <td class="manage-column alt_box">
